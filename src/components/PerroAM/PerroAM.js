...
export default function PerroAM({paso}) {
        ...
        <Fragment>
            ...
            <form className="container d-flex flex-column justify-content-center formulario" onSubmit={(event)=>{perroAM(event)}}>
                ...
                <div className="row">
                    ...
                    <div className="col-sm-8">
                        <input type="date" className="form-control" placeholder="Fecha Nacimiento" id="fechaNacimiento" name="fechaNacimiento" onChange={(event)=>handleChange(event)}  required/>
                    </div>
                </div>
                <div className="row">
